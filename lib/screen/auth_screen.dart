    ...
    try {
      if (_authMode == AuthMode.Login) {
        ...
        await Provider.of<Auth>(context, listen: false)
            .signInWithEmailAndPassword(_authData["email"], _authData["password"]);
      } else {
        // Sign user up
        await Provider.of<Auth>(context, listen: false)
            ...
            child: Column(
              children: <Widget>[
                ...
                // if (_authMode == AuthMode.Signup)
                  ...
                  AnimatedContainer(
                    constraints: BoxConstraints(maxHeight: _authMode == AuthMode.Signup ? 120 : 0,minHeight:_authMode == AuthMode.Signup ? 60 : 0 ),
                    curve: Curves.easeIn,
                    duration: Duration(milliseconds: 300),
